# Valkey Leaderboard Application

A high-performance leaderboard application built with AWS ElastiCache Valkey Serverless, demonstrating real-world usage patterns for gaming, social apps, and IoT applications.
...
- **AWS Lambda**: Serverless compute handling business logic
- **ElastiCache Valkey Serverless**: High-performance in-memory database
- **VPC**: Secure network configuration for Lambda and Valkey communication
